...
CLIENT_ID = json.loads(
    open('/home/grader/catalog/client_secrets.json', 'r').read())['web']['client_id']

APPLICATION_NAME = "CATALOG"

engine = create_engine('postgresql://grader:bluetab01@localhost:5432/catalog')
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/home/grader/catalog/client_secrets.json', scope='')
